...
class tdblockbestsellers extends Module
{
	private $_html = '';
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('ThemesDeveloper Top-seller block');
	...
	public function install()
	{
		if (!parent::install() ||
				...
				!$this->registerHook('header') ||
                                !$this->registerHook('tdPostSlider') ||
	...
	public function hookHome($params)
	{
		...
		return $this->display(__FILE__, 'tdblockbestsellers-home.tpl');
	}
	...
	public function hookLeftColumn($params)
	{
		...
		return $this->display(__FILE__, 'tdblockbestsellers.tpl');
	}
	...
	public function hooktdPostSlider($params)
	{
