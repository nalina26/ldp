...
*}
    ...
    <div class="column shown-phone">
        {$themesdev.td_extras_link|html_entity_decode}
    </div>

<!-- Block myaccount module -->
  <div class="column">
    <h3>{l s='My account' mod='blockmyaccountfooter'}</h3>
		<ul>
			<li><a href="{$link->getPageLink('history', true)|escape:'html':'UTF-8'}" title="{l s='My orders' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My orders' mod='blockmyaccountfooter'}</a></li>
                        <li><a href="{$link->getPageLink('my-account', true)}" title="{l s='My Account' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My Account' mod='blockmyaccountfooter'}</a></li>
