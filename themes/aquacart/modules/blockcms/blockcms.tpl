...
{if $block == 1}
    ...
    {foreach from=$cms_titles key=cms_key item=cms_title}
        <section id="informations_block_left_{$cms_key}" class="block informations_block_left">
            <h1 class="general_heading">{if !empty($cms_title.name)}{$cms_title.name}{else}{$cms_title.category_name}{/if}</h1>            
...
{else}
      <div class="column shown-phone">
        <h3>{l s='Information' mod='blockcms'}</h3>
        <ul>
