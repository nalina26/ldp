		...
		<form method="post" id="form_wishlist">
			<fieldset>
				...
				<p class="submit">
                    <button 
                    id="submitWishlist" 
                    class="btn btn-default button button-medium wishlist-btn" 
                    type="submit" 
                    name="submitWishlist">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th class="item mywishlist_first mywishlist-viewed">{l s='Viewed' mod='blockwishlist'}</th>
							<th class="item mywishlist_second mywishlist-created">{l s='Created' mod='blockwishlist'}</th>
					...
					<tbody>
						{section name=i loop=$wishlists}
							<tr id="wishlist_{$wishlists[i].id_wishlist|intval}" class="wishlist-content">
								<td style="width:200px;" class="first_item_content">
								...
								<td class="mywishlist-viewed">{$wishlists[i].counter|intval}</td>
								<td class="mywishlist-created">{$wishlists[i].date_add|date_format:"%Y-%m-%d"}</td>
								<td>
									<a  href="javascript:;"  onclick="javascript:WishlistManage('block-order-detail', '{$wishlists[i].id_wishlist|intval}');">
