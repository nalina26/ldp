...
<form action="{$link->getModuleLink('cashondelivery', 'validation', [], true)|escape:'html'}" method="post">
    ...
    <p class="cart_navigation" id="cart_navigation">
        <a href="{$link->getPageLink('order', true)}?step=3" class="button btn btn-default"><span><i class="icon-chevron-left"></i>{l s='Other payment methods' mod='cashondelivery'}</span></a>
