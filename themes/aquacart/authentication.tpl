...
{if !isset($email_create)}
	...
	<div class="alert alert-danger">
		{if {$authentification_error|@count} == 1}
			<p>{l s='Theres at least one error'} :</p>
			{else}
	...
	<div class="col2-set">
		<div class="col-1 new-users box-in">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
                             <div class="content">
				<div class="tital">
                                    <div class="hr"><h2>{l s='Create an account'}</h2></div>
                                </div>
		...
		<div class="col-2 registered-users box-in">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
				<div class="content">
				  ...
				  <div class="tital">
                                    <div class="hr"><h2>{l s='Already registered?'}</h2></div>
                                </div>
					<div class="form-group">
	...
	{if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
                    <div class="new-users">
                    <div class="box content newinstentuser">
				<div id="opc_account_form" style="display: block; ">
<h3 class="page-heading instant-checkout">{l s='Instant checkout'}</h3>
					...
					<div class="form-group date-select">
						...
						<div class="row">
							...
							<div class="col-xs-4 year-select">
...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation content">
              
                         
				  <div class="tital">
                                    <div class="hr"><h2>{l s='Your personal information'}</h2></div>
                                </div>
