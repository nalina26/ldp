...
{if isset($p) AND $p}
	...
	{if $nb_products > $products_per_page}
		<form action="{if !is_array($requestNb)}{$requestNb}{else}{$requestNb.requestUrl}{/if}" method="get" class="nbrItemPage limit">
                    <div class="limit">
				...
				<b for="nb_item{if isset($paginationId)}_{$paginationId}{/if}">{l s='Show'}</b>
...
{*
    <div class="limit"><b>Show:</b>
      <select onchange="location = this.value;">
                        <option value="clothing/women-clothing?limit=16" selected="selected">16</option>
                                <option value="clothing/women-clothing?limit=32">32</option>
                                <option value="clothing/women-clothing?limit=64">64</option>
                                <option value="clothing/women-clothing?limit=100">100</option>
